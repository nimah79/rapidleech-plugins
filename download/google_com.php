...
class google_com extends DownloadClass {
	...
	public function Download($link) {
		...
		if (substr($page, 7, 3) == '404') html_error('File/Folder doesn\'t exists.');
	...
	private function isPrivate($page) {
		if (substr($page, 7, 2) == '30') is_present($page, 'Location: https://www.google.com/accounts/ServiceLogin', 'Private File/Folder.');
