...
class aparat_com extends DownloadClass {
	public function Download($link) {
		...
		if (!preg_match_all('@https?://(?:[\w-]+\.)*aparat\.com/aparat-video/\w+(?:-(\d+p))?__\w+\.mp4@i', $page, $DL)) html_error('Download link not found.', PREG_SET_ORDER);
